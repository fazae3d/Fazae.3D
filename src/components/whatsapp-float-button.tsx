...
export async function WhatsAppFloatButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-5 z-40 flex h-11 w-11 items-center justify-center rounded-full bg-[#25D366] text-paper shadow-lg transition-transform hover:scale-105 lg:bottom-5"
    >
